...
from deepdb.aqp_spn.custom_spflow.custom_rdc import getIndependentRDCGroups_py
...
def learn_mspn(
    ...
    from deepdb.aqp_spn.custom_spflow.custom_structure_learning import get_next_operation, learn_structure
...
def create_custom_leaf(data, ds_context, scope):
    ...
    if meta_type == MetaType.REAL:
        ...
        from deepdb.aqp_spn.custom_spflow.custom_validity import is_valid_prob_sum
