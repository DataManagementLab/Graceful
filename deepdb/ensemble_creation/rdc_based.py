...
from deepdb.db_connection.utils import construct_db_connection
...
def candidate_evaluation(schema, meta_data_path, sample_size, spn_sample_size, max_table_data, ensemble_path,
                         ...
                         incremental_learning_rate=0, incremental_condition=None, db_kwargs: dict = None, ):
    ...
    if physical_db_name is not None:
        db_connection = construct_db_connection(db_name=physical_db_name, **db_kwargs)
